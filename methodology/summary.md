...
*(See [Measuring recall](./full.md#measuring-recall) in the detailed methodology.)*
...
*(See [Measuring precision](./full.md#measuring-precision) in the detailed methodology.)*
...
We're also evaluating ELO/Bradley-Terry ratings and Item Response Theory (borrowed from standardized testing) for cross-version comparisons as the benchmark matures. *(See [Avoiding staleness and contamination](./full.md#avoiding-staleness-and-contamination) in the detailed methodology.)*
...
Each stage is documented, versioned, and open for feedback. *(See [Roadmap](./full.md#roadmap) in the detailed methodology.)*
